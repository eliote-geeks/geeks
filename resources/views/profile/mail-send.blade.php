                                ...
                                <div class="col-xxl-10 col-xl-9 col-12">
                                    ...
                                    <div>
                                        ...
                                        @forelse ($mails as $mail)
                                            ...
                                            <!-- list group itme -->
                                            <div class="list-group-item list-group-item-action px-4 list-mail {{$mail->read == '0' ? 'bg-light' : ''}}">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!-- rating -->
                                                    <div class="me-4">
                                                    @if(\App\Models\StarMail::where('mail_id',$mail->id)->count() > 0)
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="list-title" >
                                                            <a class="fw-semi-bold text-dark" href="{{route('mailDetails',$mail->id)}}">{!!\Str::title($mail->subject)!!}</a>
                                                        </div>
                                                        <!-- text -->
                                                        <div class=" me-6 w-xxl-50 w-lg-20 w-md-10 w-5">
                                                            <a href="{{route('mailDetails',$mail->id)}}" >  <p class="mb-0 fw-semi-bold text-dark list-text"> {!!\Str::limit($mail->body,400)!!} </p></a>
                                                        </div>
                                                        <!-- badge -->
                                                        <div class="list-badge d-none d-lg-block">
                                                        @if(\App\Models\User::find($mail->author_id)->user_type == 'App\Models\Instructor')
                                                    ...
                                                    <!-- time -->
                                                    <div class="list-time">
                                                        <p class="mb-0">{{\Carbon\Carbon::parse($mail->created_at)->format('h:i a')}}</p>
                                                    </div>
                                                </div>
                                                </div>
                                               ...
                                               <!-- mail action -->
                                                <div class="actions-mail">
                                                      <a href="{{route('archiveEmail',$mail->id)}}">  <span class="fe fe-archive" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive">

                                                        </span>
                                                    </a>
                                                    <a href="{{route('deleteMail',$mail->id)}}">
                                                        <span class="fe fe-trash-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">

                                                        </span>
                                                        </a>
                                                        <a href="{{route('mailDetails',$mail->id)}}">
                                                        <span class="fe fe-mail" data-bs-toggle="tooltip" data-bs-placement="top" title="Read">

                                                        </span>
                                                        </a>
                                                        <a href="{{route('starEmail',$mail->id)}}}">
  ...
  <div class="modal fade compose-mail" id="composeMailModal" tabindex="-1"  aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered  modal-xl">
      <div class="modal-content">
        ...
        <form method="post" action="{{route('storeEmail')}}" enctype="multipart/form-data">
            @csrf
