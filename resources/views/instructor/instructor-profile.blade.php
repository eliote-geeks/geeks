				...
				<div class="col-lg-8 col-md-8 col-12">
					<div class="d-flex align-items-center">
						...
						<div class="ms-3">
							...
							<span class="fs-6">Hi Teacher!!</span>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4 col-12">
					...
					<div class="card border-0 mb-4">
						...
						<div class="card-body">
							...
							<p>Status: <b>{{$user->user_type =='App\Models\Instructor' ? 'Instructor' : 'Student'}}</b></p>							
							{{-- <a href="#" class="btn-link"> Read more</a> --}}
							{{-- <img class="avatar avatar-sm" src="{{$user->profile_photo_url}}"> --}}
							<p>Join <b>{{$user->created_at->diffForHumans()}}</b></p>
                            {{\App\Models\Instructor::instructor($user->id)}}.<br>
							<h1 class="text-center"><a href="{{route('mail')}}"><i class="fe fe-mail"></i></a></h1>
							</p>
							{{-- <a href="#" class="btn-link"> Read more</a> --}}
						</div>
					</div>
					...
					<div class="card border-0 mb-4 mb-lg-0">
						...
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
								<div>
									<h4 class="mb-0 fw-bold">{{$user->courses->count()}}</h4>
							...
							<div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
								<div>
									<h4 class="mb-0 fw-bold">{{\App\Models\Instructor::students($user->id)}}</h4>
							...
							<div class="d-flex align-items-center justify-content-between">
								<div>
									<h4 class="mb-0 fw-bold">{{\App\Models\Instructor:: studentRate($user->id)}}</h4>
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<div class="card border-0">
						...
						<div class="card-header">
							<h4 class="mb-0">
								My Courses <span class="text-muted fs-6">({{$user->courses->count()}})</span>
							</h4>
						</div>
						<!-- Card body -->
						<div class="card-body">
									...
									<div class="d-flex align-items-center justify-content-between">
										<a href="{{route('courses.show',$course)}}">
											<div class="d-lg-flex align-items-center">
												...
												@if($course->id == $cour && $cour!=null)		<span class="badge bg-light-success text-success">Old</span> @endif
													</h4>
